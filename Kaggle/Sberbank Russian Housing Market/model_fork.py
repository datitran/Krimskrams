...
# Next line just adds a lot of NA columns (because 'join' only works on indexes)
# but somehow it seems to affect the result
...
newpreds.to_csv('submissions_adjusted.csv', index=False)
